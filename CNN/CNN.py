...
from Utils import deserialize_normalized_reviews, deserialize_my_normalized_reviews, create_embedding_matrix, \
    serialize_ruscorpora_data, split_ruscorpora_data
...
model = Sequential()
model.add(Embedding(ruscorpora_data.size, input_length, weights=[embedding_matrix], input_length=input_length,
                    trainable=False))
